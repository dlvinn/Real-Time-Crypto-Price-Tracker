...
<div className='dark:bg-gray-900 bg-white flex justify-center items-center p-14 h-screen text-3xl text-yellow-100'>
  <ul className='dark:bg-gray-800 bg-yellow-100 rounded-xl shadow-2xl shadow-yellow-400'>
